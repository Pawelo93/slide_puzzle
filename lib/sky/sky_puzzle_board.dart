...
/// {@endtemplate}
class SkyPuzzleBoard extends StatefulWidget {
  /// {@macro dashatar_puzzle_board}
  const SkyPuzzleBoard({
    Key? key,
    required this.tiles,
  }) : super(key: key);
  ...
  @override
  State<SkyPuzzleBoard> createState() => _SkyPuzzleBoardState();
}

class _SkyPuzzleBoardState extends State<SkyPuzzleBoard> {
