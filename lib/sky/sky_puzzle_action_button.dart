...
/// {@endtemplate}
class SkyPuzzleActionButton extends StatefulWidget {
  /// {@macro dashatar_puzzle_action_button}
  const SkyPuzzleActionButton({Key? key, AudioPlayerFactory? audioPlayer})
  ...
  @override
  State<SkyPuzzleActionButton> createState() =>
      _SkyPuzzleActionButtonState();
}

class _SkyPuzzleActionButtonState
    extends State<SkyPuzzleActionButton> {
